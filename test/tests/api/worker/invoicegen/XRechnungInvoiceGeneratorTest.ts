...
o.spec("XRechnungInvoiceGenerator", function () {
	...
	o("japan invoice 2_items", async function () {
		...
		const generated = new XRechnungInvoiceGenerator(invoiceData, "1978197819801981931", "MyCustomerId", "test@tutao.de").generate()
