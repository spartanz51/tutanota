...
export default {
	...
	"keys": {
		...
		"imapAccountUsername_label": "Email address",
		...
		"imapImportSetup_title": "Email Migration",
		...
		"imapImportStartedSuccess_msg": "Your synchronization is active now",
		...
		"imapNoSyncActive_msg": "Currently no synchronization active",
		"imapSync_title": "Email Imap Sync",
		"imapSyncInfo_msg": "Explaining how easy imap is. ",
		"imapSyncStart_action": "Add Synchronization",
		"imapSyncCredentials_title": "Credentials",
		...
		"imapImportWindowClosedFailure_msg": "It appears the login window was closed without success, please try again.",
		"imapImportMailBoxListFailure_msg": "Failed during initial connection, cause: {error}",
		"imapChooseFolder_msg": "Choose a folder",
		"labelInput_label": "Label name",
		"imapLabelInput_helpLabel": "This label to be applied to every imported mail",
		"imapImportSummaryAccount_label": "Account",
		"imapImportSummaryExportInformation_label": "Export information",
		"imapImportSummaryHost_label": "Host",
		"imapImportSummaryImportInformation_label": "Import Information",
		"label_label": "Label",
