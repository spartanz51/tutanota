...
export default {
	...
	"keys": {
		...
		"imapSyncPostponed_msg": "Synchronizing limit reached for today, will continue tomorrow.",
		"imapSyncIntroductionInfo_msg": "Please enter the login credentials of the account you want to synchronize",
		"imapSyncConfigInfo_msg": "Choose where imported emails go",
		...
		"imapLabelInput_helpLabel": "Label to be applied to every imported mail",
