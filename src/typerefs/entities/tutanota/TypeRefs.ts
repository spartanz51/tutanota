...
export const TokenEndpointResponseTypeRef: TypeRef<TokenEndpointResponse> = new TypeRef("tutanota", 1852)

export function createTokenEndpointResponse(values: StrippedEntity<TokenEndpointResponse>): TokenEndpointResponse {
    return Object.assign(create(typeModels[TokenEndpointResponseTypeRef.typeId], TokenEndpointResponseTypeRef), values)
}

export type TokenEndpointResponse = {
	_type: TypeRef<TokenEndpointResponse>;
	_original?: TokenEndpointResponse
...
export const ImportImapAccountTypeRef: TypeRef<ImportImapAccount> = new TypeRef("tutanota", 1858)
...
export type ImportImapAccount = {
	...
	tokenEndpointResponse: null | TokenEndpointResponse;
}
export const ImportedImapMailTypeRef: TypeRef<ImportedImapMail> = new TypeRef("tutanota", 1865)
...
export const DeduplicatedImportedAttachmentTypeRef: TypeRef<DeduplicatedImportedAttachment> = new TypeRef("tutanota", 1875)
...
export const ImportImapFolderSyncStateTypeRef: TypeRef<ImportImapFolderSyncState> = new TypeRef("tutanota", 1886)
...
export const ImportImapAccountSyncStateTypeRef: TypeRef<ImportImapAccountSyncState> = new TypeRef("tutanota", 1903)
...
export const ImportImapFolderPostInTypeRef: TypeRef<ImportImapFolderPostIn> = new TypeRef("tutanota", 1919)
...
export const ImportImapFolderPostOutTypeRef: TypeRef<ImportImapFolderPostOut> = new TypeRef("tutanota", 1927)
...
export const ImportImapFolderDeleteInTypeRef: TypeRef<ImportImapFolderDeleteIn> = new TypeRef("tutanota", 1930)
...
export const ImportImapPostInTypeRef: TypeRef<ImportImapPostIn> = new TypeRef("tutanota", 1934)
...
export const ImportImapPostOutTypeRef: TypeRef<ImportImapPostOut> = new TypeRef("tutanota", 1945)
...
export const ImportImapDeleteInTypeRef: TypeRef<ImportImapDeleteIn> = new TypeRef("tutanota", 1948)
