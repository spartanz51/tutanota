...
export type ServerImapImportParams = Pick<tutanotaTypeRefs.ImportImapAccount, "host" | "port"> & { authType: ImapAuthType; oauthConfig?: OauthConfigParams }
