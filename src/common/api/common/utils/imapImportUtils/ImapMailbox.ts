import { ImapSyncSessionMailbox } from "../../../../desktop/imapimport/adsync/ImapSyncSessionMailbox.js"
import type { ListTreeResponse, MailboxObject } from "imapflow"
import { ImportImapFolderSyncStatus, MailSetKind, SystemFolderType } from "@tutao/app-env"
...
export class ImapMailboxStatus {
	...
	syncStatus: ImportImapFolderSyncStatus = ImportImapFolderSyncStatus.NotInitialized
	...
	setSyncStatus(syncStatus: ImportImapFolderSyncStatus): this {
	...
	static fromImapFlowMailboxObject(mailboxObject: MailboxObject): ImapMailboxStatus {
		return new ImapMailboxStatus(mailboxObject.path, mailboxObject.uidNext, mailboxObject.uidValidity)
			...
			.setSyncStatus(ImportImapFolderSyncStatus.Running)
	}
}
