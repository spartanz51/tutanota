...
import { Base64, base64ToBase64Url, base64ToUint8Array, Base64Url, hexToUint8Array, Nullable, uint8ArrayToArrayBuffer, uint8ArrayToBase64 } from "@tutao/utils"
...
export const KDF_NONCE_LENGTH_BYTES = 32 // TODO this is probably enough, but it is not mentioned in the spec anywhere.
